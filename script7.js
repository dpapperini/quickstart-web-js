...
function stopRecordingCallback() {
    ...
    mediaRecorder.stopRecording(function() {
      recordedBlobs = this.getBlob();
      console.log('Recorded Blobs: ', recordedBlobs);
      mediaRecorder.getDataURL(function(dataURI) {
        video.src = dataURI;
        video.controls = true;
...
function stopRecordingCallback() {
  ...
  var blob = new File(recordedBlobs, 'video.webm', {
      type: 'video/webm'
  });
...
function startRecordingCallback() {
  ...
  const internalRecorder = mediaRecorder.getInternalRecorder();
  console.log('internal-recorder', internalRecorder.name);

  // if you want to read recorder's state
  console.log('recorder state: ', mediaRecorder.getState());
}
